...
import { connectionInvolvesAddress,generateUTXOKey } from '../utils/utxoKeyGeneration';
...
export const NodeTxPicker: React.FC<Props> = ({ open, address, onOpenChange, onAdd, nodeLabel, existingConnections = [] }) => {
