...
const CustomNodeExpandDialog: React.FC<Props> = ({ open, onOpenChange, sourceNode, existingNodes, onCreateEdges, existingConnections = [], onEditEdges }) => {
...
export default CustomNodeExpandDialog