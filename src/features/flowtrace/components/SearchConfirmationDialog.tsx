...
export const SearchConfirmationDialog: React.FC<SearchConfirmationDialogProps> = ({
  open,
  onOpenChange,
  newAddress,
  existingNodeCount,
          ...
          <DialogDescription className="space-y-4 text-base">
            <div className="rounded-lg bg-gray-50 dark:bg-gray-800/50 p-4 w-full">
              <p className="font-medium text-gray-900 dark:text-gray-50 mb-3 text-base">
                You're about to search for a new address:
              </p>
...
export default SearchConfirmationDialog;